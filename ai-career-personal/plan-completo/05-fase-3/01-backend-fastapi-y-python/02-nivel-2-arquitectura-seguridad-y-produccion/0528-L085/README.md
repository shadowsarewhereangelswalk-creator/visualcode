# L085 — Inyección de Dependencias

- **Orden:** 528 de 580
- **Fase:** Fase 3
- **Módulo:** Backend FastAPI &amp; Python
- **Nivel:** Nivel 2: Arquitectura, Seguridad y Producción
- **Semana sugerida:** 27
- **Lección:** 2
- **Estado:** ⬜ Pendiente
- **Prioridad:** Alta
- **Herramientas:** FastAPI
- **Duración estimada:** 2 h de clase + 2 h de práctica

## Objetivo de aprendizaje

Reutilizar lógica y configuración.

## Conceptos clave

Depends, dependency injection, session

## Ejercicio guiado

Crear dependencia para DB/session.
