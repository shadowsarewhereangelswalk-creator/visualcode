# UNE12D28 — Fundamentos de contenedores, variables de entorno y puertos

Clase 28 del Nivel 12 — Testing, buenas prácticas y despliegue.

- **Práctica:** Fundamentos de contenedores, variables de entorno y puertos
- **Resultado terminado:** Aplicación configurable por variables de entorno con publicación de puertos.
- **Herramientas:** Docker, Compose y Flask y Visual Studio Code
